...
$check = mysqli_num_rows(mysqli_query($tad->tad_db(), "SELECT * FROM `nickff` WHERE `taikhoan`='$taikhoan'"));
...
mysqli_query($tad->tad_db(), "INSERT INTO `nickff` SET 
...
$last_id = mysqli_fetch_assoc(mysqli_query($tad->tad_db(), "SELECT * FROM `nickff` order by `id` desc limit 1"));
                                            ...
                                            <div class="col-md-3 col-lg-3 col-xs-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="rank" class="form-control show-tick" tabindex="-98">
                                                        ...
                                                        <option value="Đồng">Rank Đồng</option>

                                                        <option value="Bạc">Rank Bạc</option>

                                                        <option value="Vàng">Rank Vàng</option>

                                                        <option value="Bạch Kim">Rank Bạch Kim</option>

                                                        <option value="Kim Cương">Rank Kim Cương</option>

                                                        <option value="Huyền Thoại">Rank Huyền Thoại</option>

                                                        <option value="Thách Đấu">Rank Thách Đấu</option>
