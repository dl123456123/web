...
$row = mysqli_fetch_assoc(mysqli_query($tad->tad_db(), "SELECT * FROM `vongquay_kimcuong` WHERE `id`='".$_GET['edit']."'"));
...
?>
        ...
        if(isset($_POST['submit'])) {
              ...
              $thumb = $_POST['thumb'];
                ...
                mysqli_query($tad->tad_db(), "UPDATE `vongquay_kimcuong` SET `name` = '".$name."', `mota` = '".$mota."',`thumb` = '".$thumb."', `image` = '".$image."', `giatien` = '".$giatien."' WHERE `id`='".$_GET['edit']."'");



                mysqli_query($tad->tad_db(), "UPDATE `vongquay_kimcuong_gift` 

                    SET 

                    `item_1` = '".mysqli_real_escape_string($tad->tad_db(), json_encode($data[0]))."', 

                    `item_2` = '".mysqli_real_escape_string($tad->tad_db(), json_encode($data[1]))."', 

                    `item_3` = '".mysqli_real_escape_string($tad->tad_db(), json_encode($data[2]))."', 

                    `item_4` = '".mysqli_real_escape_string($tad->tad_db(), json_encode($data[3]))."', 

                    `item_5` = '".mysqli_real_escape_string($tad->tad_db(), json_encode($data[4]))."', 

                    `item_6` = '".mysqli_real_escape_string($tad->tad_db(), json_encode($data[5]))."', 

                    `item_7` = '".mysqli_real_escape_string($tad->tad_db(), json_encode($data[6]))."', 

                    `item_8` = '".mysqli_real_escape_string($tad->tad_db(), json_encode($data[7]))."' WHERE `id_vongquay`='".$_GET['edit']."'");



                    echo '<div class="alert alert-primary alert-dismissible bg-primary text-white border-0 fade show" role="alert">Update Vòng Quay <b>"'.$name.'" Thành Công!</b></div><script>location.href="/admin/list/vongquaykimcuong";</script>';
...
$rows = mysqli_fetch_assoc(mysqli_query($tad->tad_db(), "SELECT * FROM `vongquay_kimcuong_gift` WHERE `id_vongquay`='".$_GET['edit']."'"));
